...
# c. Is there a relationship between shoe size and height? Why? - Yes, there is a relationship between shoe size and height, the shoe sizes is big when the respondents is also tall. If the height of the respondents is below 70.0 their shoe size will be small.
